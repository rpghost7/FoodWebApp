...
// here we are storing the timeout ID generated by setTimeout and later it checks when another object is added , that if the timeout ID exists clear the timeout and start a new one
