...
export default function Checkout() {
  function Message({ content }) {
    return (
      <div className="text-3xl flex flex-col justify-center items-center text-white">
        <p>{content}</p>
        <p>Thank you for ordering from us, we hope you have a great time!</p>
      </div>
    );
  }
