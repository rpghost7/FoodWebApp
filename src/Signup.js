                ...
                <div className='mt-32 bg-violet-700 w-1/4 rounded-3xl'>
                    ...
                    <form>
                        <div className='block p-5'>
                            <label for="name" className='text-white text-xl'>Name:</label>
                            <input className='block w-full border-4 border-solid focus:border-violet-300 focus:outline-none rounded-xl' type="text" id="name" name="name" required />
                        </div>
                        <div className='block p-5'>
                        ...
                        <div className='flex justify-center space-x-3 p-5'>
                            ...
                            <button className='text-stone-700 text-lg bg-violet-400 p-2 rounded-lg hover:text-stone-800 hover:bg-violet-300 hover:text-xl' type='button'>Already a User?</button>
                        </div>
                    </form>
                </div>
            </div>
